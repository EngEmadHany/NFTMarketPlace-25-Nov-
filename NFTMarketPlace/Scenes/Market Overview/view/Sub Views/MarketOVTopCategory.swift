...
struct marketPriceOverView: View {
    ...
    @Binding var categorysType: MOVTopCategorys 
    // MARK: - view compnents
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 2) {
            HStack(spacing: 15) {
                ForEach(MOVTopCategorys.allCases, id: \.self) { category in
                    PickerSelectors(title: category.tabText, isSelected: categorysType == category)
                    
                        .onTapGesture {
                            categorysType = category
                        }
                }
            }
            .padding()
...
//                DoughnutChart(chartData: viewModel.averageWatchTimeData())
